...
class cat_ins_institucionController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validatedData = $request->validate([
            ...
            [
                'nombre_ins.required' => 'La institucion es requerida',
                'nombre_ins.max' => 'La institucion debe contener como maximo 226 caracteres'
            ]
        );
        ...
        Return redirect('catInstitucion')->with('message','Institución Registrada correctamente!') ;
    }
