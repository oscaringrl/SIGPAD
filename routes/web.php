...
Route::resource ('dcnInv','dcn_inv_investigacionController');//GP04-2019
...
Route::post('getInvestigaciones', 'GestionDocenteController@getInvestigaciones')->name('getInvestigaciones'); //Grupo 04
